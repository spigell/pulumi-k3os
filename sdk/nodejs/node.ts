...
export class Node extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'k3os:index:Node';
...
export interface NodeArgs {
    readonly connection: pulumi.Input<inputs.ConnectionArgs>;
    readonly nodeConfiguration: pulumi.Input<inputs.NodeConfigurationArgs>;
}
